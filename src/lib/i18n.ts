...
const en: I18nTexts = {
  ...
  keyword: {
    ...
    ogTitle: "Korean Market Keyword Analyzer - WealthPipe",
    ogDesc: "Unlock Naver SEO data — volume, competition, and revenue potential for the Korean market.",
  ...
  signals: {
    ...
    ogDesc: "AI-powered daily buy/sell signals for KOSPI, S&P 500, NASDAQ, Bitcoin, Gold, and USD/KRW.",
