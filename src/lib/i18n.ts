...
const en: I18nTexts = {
  ...
  hero: {
    ...
    line2a: "ANALYZED",
    line2b: "BY AI.",
    desc: "Stock screening, trading signals, economic news, and Korean SEO keyword analysis — all done by AI, every day.",
    descHighlight: "100% free. No signup needed. Try it now.",
    ctaPrimary: "Try Free Tools →",
    ctaSecondary: "Subscribe",
  },
  stats: [
    ["2,700+", "Stocks screened daily"],
    ["4", "Free tools, no login"],
    ["24/7", "AI updates every morning"],
    ["10 min", "Daily briefing read time"],
  ],
  tools: {
    heading1: "FREE",
    heading2: "TOOLS",
...
const ko: I18nTexts = {
  ...
  hero: {
    tagline: "— 매일 아침, AI가 정리해주는 투자 정보",
    line1a: "키워드 분석부터",
    line1b: "매매 신호까지.",
    line2a: "AI가 매일",
    line2b: "알려드립니다.",
    desc: "종목 스크리닝, 매매 신호, 경제 뉴스, 키워드 분석까지 — AI가 매일 자동으로 정리해드립니다.",
    descHighlight: "100% 무료. 로그인도 필요 없어요.",
    ctaPrimary: "지금 바로 써보기 →",
